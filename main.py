...
# !rm -rf /content/text_renderer/text_renderer/output/images/
# %cd /content/text_renderer
# !python3 main.py \
#     --config /content/text_renderer/config.py \
#     --dataset img \
#     --num_processes 8 \
#     --log_period 10


# python3 main.py --config "/Users/apple/text_renderer/config.py" --dataset img --num_processes 8 --log_period 10